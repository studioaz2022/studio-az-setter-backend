# Content Intake — Studio AZ Tattoo

> **What this is:** Every question the business owner needs to answer before we can write SEO-optimized page content. Phase 2 (SEO architecture) defines *how* content should be structured. This file captures the *what* — the raw business knowledge that only you have.
>
...
## Section 1: Business Identity (confirm or correct)

These are pre-filled from what we know. Just confirm or fix.

**Q1.1** Business name (exact spelling used everywhere):
Answer: Studio AZ Tattoo

**Q1.2** Address (exact format — "STE" or "Suite"? "Ave N" or "Avenue North"?):
Answer: 333 Washington Ave N, STE 100, Minneapolis, MN 55401
...
## Section 9: FAQ — Additional Questions

These are questions we'll include on the FAQ page. Some answers come from sections above, but these need direct answers too:

**Q9.1** "Does getting a tattoo hurt?" — What do you tell nervous first-timers?
Answer:
...
## Section 10: Images Needed

Check off what you have or can get. We need real photos only — zero stock images.
...
- [ ] Fresh tattoo (day 1)
- [ ] Healing tattoo (peeling stage)
- [ ] Healed tattoo (final result)

---

## Section 11: Spanish Content

**Q11.1** Who will review/write the Spanish content? (Joan? External translator? You?):
Answer:

**Q11.2** Should the Spanish be formal (usted) or informal (tú)?
Answer:

**Q11.3** Any Spanish-specific messaging? (e.g., "Hablamos español" prominently on homepage):
Answer:
